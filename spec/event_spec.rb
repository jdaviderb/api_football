...
RSpec.describe ApiFootball::Event do
  let(:api_key) do
  ...
  describe "#filter_by" do
    ...
    let(:filter_by_league) do
      subject.filter_by(to: to, from: from, league_id: championship)
    end

    it "filter by league" do
      VCR.use_cassette("events/filter_by_league") do
